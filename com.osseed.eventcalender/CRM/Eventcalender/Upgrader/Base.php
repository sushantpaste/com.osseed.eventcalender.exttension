 ...
 */
class CRM_Eventcalender_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Eventcalender_Upgrader(
        'com.osseed.eventcalender',
        __DIR__ .'/../../../'
      );
    }
   ...
   *
   * @code
   * CRM_Eventcalender_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
