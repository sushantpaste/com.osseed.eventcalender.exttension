...
VALUES     
    ( @domain_id,'civicrm/showevents', 'Show Events', 'Show Events', 'access CiviCRM', 'AND', @administerID, '1', NULL, @adminCampaignWeight );
...
INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES     
    ( @domain_id,'civicrm/eventcalendersettings', 'Event Calender Settings', 'Event Calender Settings', 'access CiviCRM', 'AND', @administerID, '1', NULL, @adminCampaignWeight );
